...
void QMetaObjectInvokeMethod(QObject *,const char * signature,const QList<QGenericArgument> & args);
void QMetaObjectInvokeMethod(QObject *,const char * signature,const QList<QVariant> & args);
