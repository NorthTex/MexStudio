...
class Texstudio : public QMainWindow {
	...
	public:
		...
		Q_INVOKABLE void runInternalCommand(const QString & command,const QString & master,const QString & options);
	...
	protected:
		...
		Q_INVOKABLE inline QAction * newManagedAction(QWidget * menu,const QString & id,QAction * action){
			return configManager.newManagedAction(menu,id,action); }
