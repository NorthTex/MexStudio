...
struct LatexLogEntry {
	...
	static QColor textColor(LogType type){
...
class LOFStackItem {
	...
	public:
		...
		explicit LOFStackItem(const QString & file = QString(),bool sure = false)
			: m_file(file)
			, m_reliable(sure) {}
...
class LatexOutputFilter : public OutputFilter {
	...
	protected:
		...
		void updateFileStackHeuristic2(Line,Cookie);
		void updateFileStackHeuristic(Line,Cookie);
		void updateFileStack(Line,Cookie);
	...
	protected:
		...
		virtual short parseLine(Line,short dwCookie);

		bool detectLatex3Info(Line,Cookie);
		bool detectError(Line,Cookie);
		bool detectWarning(Line,Cookie);
		bool detectBadBox(Line,Cookie);
		bool detectLaTeXLineNumber(QString & warning,Cookie,int length);
		bool detectBadBoxLineNumber(QString & strLine,Cookie,int length);

		static bool isBadBoxTextQuote(Line);
